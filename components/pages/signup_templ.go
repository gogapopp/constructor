...
func SignUp(errMsg string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if errMsg != "" {
			...
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("</p><button class=\"ml-auto text-sm text-red-700 hover:text-red-900 underline transition-colors\" onclick=\"window.location.href=&#39;/signin&#39;\">Sign in instead</button></div></div>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
		}
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<form class=\"space-y-6\" action=\"\" method=\"post\"><div class=\"space-y-5\"><div class=\"space-y-1\"><label class=\"block text-sm font-medium text-gray-700\">Username</label> <input class=\"w-full px-4 py-3 rounded-lg bg-gray-50 border border-gray-200 \r\n                                       placeholder-gray-400\r\n                                       transition-colors duration-200\r\n                                       focus:bg-white focus:outline-none focus:border-black focus:ring-1 focus:ring-black\" type=\"text\" name=\"username\" required minlength=\"4\" maxlength=\"64\" placeholder=\"Choose a username\"><p class=\"mt-1 text-sm text-gray-500\">Must be 4-64 characters long</p></div><div class=\"space-y-1\"><label class=\"block text-sm font-medium text-gray-700\">Email</label> <input class=\"w-full px-4 py-3 rounded-lg bg-gray-50 border border-gray-200 \r\n                                       placeholder-gray-400\r\n                                       transition-colors duration-200\r\n                                       focus:bg-white focus:outline-none focus:border-black focus:ring-1 focus:ring-black\" type=\"email\" name=\"email\" required autofocus placeholder=\"Enter your email\"></div><div class=\"space-y-1\"><label class=\"block text-sm font-medium text-gray-700\">Password</label> <input class=\"w-full px-4 py-3 rounded-lg bg-gray-50 border border-gray-200 \r\n                                       placeholder-gray-400\r\n                                       transition-colors duration-200\r\n                                       focus:bg-white focus:outline-none focus:border-black focus:ring-1 focus:ring-black\" type=\"password\" name=\"password\" required minlength=\"6\" placeholder=\"Create a password\"><p class=\"mt-1 text-sm text-gray-500\">Must be at least 6 characters</p></div><div class=\"space-y-1\"><label class=\"block text-sm font-medium text-gray-700\">Confirm Password</label> <input class=\"w-full px-4 py-3 rounded-lg bg-gray-50 border border-gray-200 \r\n                                       placeholder-gray-400\r\n                                       transition-colors duration-200\r\n                                       focus:bg-white focus:outline-none focus:border-black focus:ring-1 focus:ring-black\" type=\"password\" name=\"password_confirm\" required minlength=\"6\" placeholder=\"Confirm your password\"></div></div><button class=\"w-full bg-black text-white mt-6 px-6 py-3 rounded-lg font-medium\r\n                               transform transition-all duration-200\r\n                               hover:bg-gray-900 hover:scale-[1.01]\r\n                               active:scale-[0.99]\r\n                               focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900\" type=\"submit\">Create Account</button></form><div class=\"text-center\"><p class=\"text-sm text-gray-500\">Already have an account? <button onclick=\"window.location.href=&#39;/signin&#39;\" class=\"ml-1 text-black hover:text-gray-900 underline transition-colors\">Sign in</button></p></div></div></div></section>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return templ_7745c5c3_Err
